...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-cloud-browser-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9232&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-cloud-browser-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-cloud-browser` can be installed with:

```
conda install django-cloud-browser
```

It is possible to list all of the versions of `django-cloud-browser` available on your platform with:
